...
function userDisplayGeneralInfos($pUser)
{
	...
	switch ($userGetClass) {
		case "Apprenti":
			...
			echo $formation['nameFormation'] . '<br />' . $formation['nameComposante'] . '<br />Représentant pédagogique : ' . $formation['nameRepresentantPedagogique'] . '<br />Téléphone : ' . $formation['telRepresentantPedagogique'] . ' - Portable : ' . $formation['cellRepresentantPedagogique'] . '<br />Email : ' . $formation['mailRepresentantPedagogique'] . '</p><h2>Entreprise</h2><p>';
			$company = $pUser->getCompanyInfos();
			echo $company['companyName'] . '<br />' . $company['companyAdress'] . "</p><h2>Maître d'apprentissage</h2><p>";
			$maitreApprentissage = $pUser->getMaitreApprentissageInfos();
			echo $maitreApprentissage['nameMaitreApprentissage'] . '<br />' . $maitreApprentissage['functionMaitreApprentissage'] . '<br />Téléphone : ' . $maitreApprentissage['telMaitreApprentissage'] . " - Portable : " . $maitreApprentissage['cellMaitreApprentissage'] . '<br />Email : ' . $maitreApprentissage['mailMaitreApprentissage'] . '</p><h2>Tuteur pédagogique</h2><p>';
			$tuteurPedagogique = $pUser->getTuteurPedagogiqueInfos();
			echo $tuteurPedagogique['nameTuteurPedagogique'] . '<br />Téléphone : ' . $tuteurPedagogique['telTuteurPedagogique'] . ' - Portable : ' . $tuteurPedagogique['cellTuteurPedagogique'] . '<br />Email : ' . $tuteurPedagogique['mailTuteurPedagogique'] . '</p>';
	}
}
function userLogout()
{
