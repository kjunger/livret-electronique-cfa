...
<form action="" method="">
    ...
    <div class="conteneur large" id="choixAnneePro" style="visibility: hidden;"></div>
    <div class="conteneur large">
        <div class="titre">
...
<script type="application/javascript">
    $('document').ready(function () {
        $('#anneeProchaine').fancySelect().on('change.fs', function() {
            $(this).trigger('change.$');
            var choixSelect = $(this).find(':selected').val();
            if (choixSelect != "recherchePoursuiteEtudes") {
                switch (choixSelect) {
                    case "poursuiteEtudes":
                        $('#choixAnneePro').empty();
                        $('#choixAnneePro').attr("style","visibility: visible;");
                        $('#choixAnneePro').append('<div class="titre">\n\
                            <h1>Etablissement</h1>\n\
                        </div>\n\
                        <div class="contenu">\n\
                ...
                $('#choixAnneePro').empty();
                $('#choixAnneePro').attr("style","visibility: hidden;");
            }
        });
    });
</script>