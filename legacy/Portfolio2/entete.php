...
require($racine."classes/evaluation.class.php");
require($racine."classes/formation.class.php");
require($racine."classes/note.class.php");
require($racine."classes/critere.class.php");
require($racine."classes/categorie_critere.class.php");
	...
	if(in_array($_SESSION["niveau"],$droits_modif))
	{
		switch($type)
		{
			case "textarea" :
					...
					$oFCKeditor->BasePath = $racineFCKeditor.'fckeditor/' ;
					$oFCKeditor->ToolbarSet = 'Perso';
					$oFCKeditor->Value = $value ;
					$oFCKeditor->Create() ;break;
