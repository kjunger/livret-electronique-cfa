...
<form action="" method="post">
    <div class="conteneur large">
        ...
        <div class="contenu">
            ...
            <input placeholder="Adresse" type="text" value="" />
            <input placeholder="Code postal" type="text" value="" />
            <input placeholder="Ville" type="text" value="" />
            <input placeholder="Email" type="email" value="" />
            <input placeholder="Téléphone" type="text" pattern="0[0-9]{9}" value="" />
            <input placeholder="Portable" type="text" pattern="0[0-9]{9}" value="" />
