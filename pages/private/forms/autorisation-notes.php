...
<form action="" method="post">
    <div class="conteneur large">
        <div class="titre">
            <h1>Promotion <?= date('Y'); ?></h1>
        </div>
        <div class="contenu">
            <p>Je soussigné, M./Mme , autorise l' à communiquer mes résultats universitaires, dans le cadre de mon cursus en  en alternance, au maître d'apprentissage dont je dépends.</p>
